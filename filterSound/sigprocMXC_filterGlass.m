...
%srate 44.1 kHz which is typical sampling rate for auditory streams
...
%shows left and right speaker channels so what the left and right ear hears
...
% plot the time-frequency response (also known as the spectrogram)
%Each one of the little red blobs corresponds to a concentration of energy 
%at a particular frequency at a particular time - and that each of the
%keystrokes on the piano
subplot(5,1,3:5)
